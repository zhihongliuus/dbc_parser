...
struct VersionStruct {
  ...
  explicit VersionStruct(const std::string& version)
...
struct NodeStruct {
  ...
  NodeStruct() = default;
  NodeStruct(const std::string& n, const std::string& c = "")
      : name(n), comment(c) {}
};
...
class ParserContext {
 public:
  ...
  void add_environment_variable_data(
  ...
  void add_signal_extended_value_type(
...
class DbcGrammar : public qi::grammar<Iterator, Skipper> {
 ...
 private:
  ...
  qi::rule<Iterator, NodeStruct(), qi::locals<>, qi::space_type> node_def;
  qi::rule<Iterator, qi::space_type> nodes_rule;
  qi::rule<Iterator, ValueTableStruct(), qi::locals<int64_t>, qi::space_type>
      value_table_def;
  qi::rule<Iterator, qi::space_type> value_tables_rule;
  qi::rule<Iterator, SignalStruct(), qi::space_type> signal_def;
  qi::rule<Iterator, MessageStruct(), qi::space_type> message_def;
  ...
  qi::rule<Iterator, qi::space_type> signal_extended_value_types_rule;
  qi::rule<Iterator, qi::space_type> signal_groups_rule;
  qi::rule<Iterator, qi::space_type> signal_type_refs_rule;
  qi::rule<Iterator, qi::space_type> dbc_file;
...
template class DbcGrammar<std::string::const_iterator>;
template class DbcGrammar<const char*>;
